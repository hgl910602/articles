...
MARKERS = [
    ...
    ("权威腔：X的本质/真正的问题", r"的本质(应该|不是|是)|真正的问题"),
    ("黑话：底层逻辑/顶层设计", r"底层(逻辑|其实是)|顶层设计"),
    ("群像靶子：很多人却/大部分人以为", r"很多(人|开发者|团队)[^。，；！？\n]{0,20}(却|但|以为)|(大部分|大多数|许多)人(以为|认为|不理解|不知道)"),
    ("惊叹腔：朴素得惊人/简单到不像话", r"朴素得惊人|简单到不像话|说出来你可能不信|你猜怎么着"),
    ("导览腔：总地图/摊开地图", r"(给|看)一张总地图|摊开.{0,4}地图"),
    ("顶真对偶：哪里…哪里…/越…越…", r"哪里[^。，；！？\n]{1,10}[，,]哪里|越[^，。；！？\n]{1,8}越[^，。；！？\n]{1,10}"),
    ("金句腔：就不再是…", r"就不再是"),
